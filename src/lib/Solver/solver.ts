...
import minizincDefs from './minizinc/minizinc_defs.mzn?raw';
import minizincDirectPath from './minizinc/directed_path.mzn?raw';
import minizincLoopAndSnake from './minizinc/loop_and_snake.mzn?raw';
