...
export enum GLOBAL_SNAKE_CONSTRAINTS {
	SNAKE = 'Snake',
	SNAKE_CANNOT_TOUCH_ORTHOGONALLY = 'Snake Cannot Touch Orthogonally',
	SNAKE_CANNOT_TOUCH_DIAGONALLY = 'Snake Cannot Touch Diagonally',
	SNAKE_WHISPERS_LINE = 'Snake Whispers Line'
}
...
export enum SINGLE_CELL_ARROW_CONSTRAINTS {
	...
	ENTROPIC_COUNT_CELL_ARROW = 'Entropic Count Cell Arrow',
...
export enum TOOL_CATEGORIES {
	...
	GLOBAL_SNAKE_CONSTRAINTS = 'Global Snake Constraints',
