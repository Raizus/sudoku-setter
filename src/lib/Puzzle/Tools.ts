...
export const LOCAL_ELEMENTS_CATEGORIES = [
	...
	TOOL_CATEGORIES.GLOBAL_NURIMISAKI_CONSTRAINTS,
	TOOL_CATEGORIES.GLOBAL_NURIKABE_CONSTRAINTS,
	TOOL_CATEGORIES.GLOBAL_YIN_YANG_CONSTRAINTS,
	TOOL_CATEGORIES.GLOBAL_SHIKAKU_CONSTRAINTS,
