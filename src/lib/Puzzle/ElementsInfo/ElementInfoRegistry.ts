...
export const elementInfoRegistry: Record<string, SquareCellElementInfo> = {
	...
	[TOOLS.DIAGONALITY]: diagonalityInfo,
	...
	[TOOLS.ONE_CELL_SUM_OF_OTHERS_CAGE]: oneCellSumOfOthersCageInfo,
	...
	[TOOLS.YIN_YANG_X_SUM_OUTSIDE_EDGE]: yinYangXSumOutsideEdgeInfo,
