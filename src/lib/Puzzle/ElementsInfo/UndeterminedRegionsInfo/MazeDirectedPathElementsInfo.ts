import { addHeader, format_2d_array, groupConstraintsByValue, PuzzleModel, type PuzzleAuxI } from '$src/lib/Solver/solver_utils';
import { cellEdgeToCellCoords, coordsAdd, coordsScale, cornerCoordToAdjCellCoords, type GridCoordI } from '$src/lib/utils/SquareCellGridCoords';
import type { AbstractElementInfo, SquareCellElementInfo } from '../../ElementInfo';
import type { Cell } from '../../Grid/Cell';
import type { Grid } from '../../Grid/Grid';
import type { CellToolI, ConstraintsElement, CornerLineToolI, EdgeToolI } from '../../puzzle_schema';
